...
VL_MODULE(Vdff) {
  ...
  private:
    ...
    static QData _change_request_1(Vdff__Syms* __restrict vlSymsp);
...
#endif  // VL_DEBUG
  public:
    static void _eval_initial(Vdff__Syms* __restrict vlSymsp) VL_ATTR_COLD;
